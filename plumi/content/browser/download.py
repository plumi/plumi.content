...
class Download(BrowserView):
    ...
    def __call__(self):
        ...
        self.request.response.setHeader("Content-Type", file.getContentType())
        self.request.response.setHeader("Content-Length", file.get_size())
